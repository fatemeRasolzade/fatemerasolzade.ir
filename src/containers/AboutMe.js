  ...
  return (
    <div className="section">
      <div className="relative">
        <div className="mx-auto max-w-7xl text-white !flex justify-center items-center animate-banner gap-10 md:gap-32">
          <div className="flex flex-col justify-start min-w-[38rem]">
            ...
            <p className="mt-5 text-sm md:text-base font-verdana opacity-50 text-justify">
            ...
            <a
              ...
              className="text-lg md:text-xl text-main-blue mt-4 cursor-pointer icon-transition"
              href={"../assets/documents/resume.pdf"}
            >{`<Download CV />`}</a>
          </div>
          <img src={Fatemeh} alt="fatemeh" width={500} className="rounded-b-full border-t hidden md:inline" />
        </div>
